...
public class RTSCamera : MonoBehaviour
{
    ...
    // Mouse Panning speed
    public float mousePan = 0.1f; // mouse panning speed
    ...
    void Update()
    {
        ...
        if (Input.mouseScrollDelta.y!=0) {
            panTranslation += Input.mouseScrollDelta.y * Vector3.forward * Time.deltaTime * 15;
        }
        //
        ...
        if (Input.GetMouseButton(2))
        {
            ...
            transform.Translate(-mousePan*mouseDelta, Space.Self);
        }
